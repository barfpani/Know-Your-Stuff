...
VALUES
    ('Samsung', 'Samsung Galaxy 25 Ultra', 'S25 Ultra', 'Smartphone', 'samsung-galaxy-s25-ultra', '2025-01-20');


INSERT INTO product_listing(product_id, retailer_id, product_url, retailer_sku, listing_title)
VALUES
...
INSERT INTO sales_events (product_id, retailer_id, start_date, end_date, description)
VALUES
    ('Big Billion Dats', 1, '2026-10-1', '2026-10-10', 'Expected majot Flipkart discount event');

INSERT INTO recommendation_logs (product_id, current_listing_id, recommendation_type, reason,_summary, confidence_score)
VALUES
    (1, 1, 'WAIT'm 'Big Billion Days is approaching and the product has historically dropped during major sales events', 87.50);